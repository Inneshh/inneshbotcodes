...
$wait[7s]
$channelSendMessage[$getServerVar[ylog];<@$authorID>
{field:İsim Yaş:$getUserVar[yisim;$authorID] | $getUserVar[yyaş;$authorID]:yes}
{field:Başka Sunucularda Yetkilimi:$getUserVar[ybsy;$authorID]:yes}
{field:Kütüphane/Modül/Dil:$getUserVar[ykütüphane;$authorID]:yes}
{field:Günde Kaç Saat Aktif:$getUserVar[yaktiflik;$authorID]:yes}
...
{field:Yetkili Komut: $getServerVar[prefix]onayla $authorID | $getServerVar[prefix]reddet $authorID sebep}
{color:RANDOM}]
$wait[1s]
...
$setUserVar[ykütüphane;$message;$authorID]
